...
// let bowSoundHeard = false;      

// /**
//  *  resets the bow sound flag
//  */
// function resetBowSoundFlag() {
//     setTimeout(() => {
//         bowSoundHeard = false;
//         //sendDebugmsg("Bow sound flag reset after timeout.");
//     }, 1000);
// }

// register("SoundPlay", (a, b, c, d, e, f) => {

//     if (b.includes("random.bowhit") || b.includes("random.bow")) {
//         let distance = Player.asPlayerMP().distanceTo(a.x,a.y,a.z);
//         bowSoundHeard = true;

//         if (distance > 1) return sendDebugmsg(`DISTANCE: &c${distance}`)

//         //sendDebugmsg(`Bow sound detected: ${b} at time ${Date.now()}`);
//         //sendDebugmsg(`LOCATION: ${a}`)
//         sendDebugmsg(`DISTANCE: &f${distance}`)
//         resetBowSoundFlag();   
//         return;            
//     }

//     if (b.includes("tile.piston.out")) {
//         if (!bowSoundHeard) {
//             sendDebugmsg("Piston sound detected without bow sound!");
//         } else {
//             sendDebugmsg("Piston sound detected, but bow sound was heard recently.");
//         }
//     }
